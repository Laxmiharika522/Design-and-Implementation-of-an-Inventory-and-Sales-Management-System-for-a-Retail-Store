...
import { LogOut, ShoppingBag, ClipboardList, User, ChevronLeft, ChevronRight, ShoppingCart, Star } from 'lucide-react';
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="h-16 px-8 flex items-center justify-between bg-white border-b border-slate-200/60 shadow-sm sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-bold text-lg">Customer Portal</h2>
          </div>
          <div className="flex items-center gap-3">
